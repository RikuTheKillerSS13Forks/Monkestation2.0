...
/obj/structure/chess/redqueen
	...
	icon = 'monkestation/icons/monster_hunters/rabbit.dmi'
...
/obj/structure/blood_fountain
	...
	icon = 'monkestation/icons/monster_hunters/blood_fountain.dmi'
...
/obj/item/blood_vial
	...
	icon = 'monkestation/icons/monster_hunters/weapons.dmi'
...
/obj/item/blood_vial/attack_self(mob/living/user)
	...
	icon_state = "blood_vial_empty"
	update_appearance()
	playsound(src, 'monkestation/sound/monster_hunters/blood_vial_slurp.ogg',50)
