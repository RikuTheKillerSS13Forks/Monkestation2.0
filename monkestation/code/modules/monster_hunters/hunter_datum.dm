...
/datum/antagonist/monsterhunter/get_preview_icon()
	...
	var/icon/white_rabbit = icon('monkestation/icons/monster_hunters/rabbit.dmi', "white_rabbit")
	var/icon/red_rabbit = icon('monkestation/icons/monster_hunters/rabbit.dmi', "killer_rabbit")
...
/datum/antagonist/monsterhunter/greet()
	...
	owner.current.playsound_local(null, 'monkestation/sound/monster_hunters/monsterhunterintro.ogg', vol = 100, vary = FALSE, pressure_affected = FALSE)
...
/obj/item/clothing/mask/monster_preview_mask
	...
	worn_icon = 'monkestation/icons/monster_hunters/worn_mask.dmi'
...
/datum/component/echolocation/monsterhunter/generate_appearance(atom/input)
	...
	if(istype(input, /mob/living))
		...
		copied_appearance.icon = 'monkestation/icons/monster_hunters/rabbit.dmi'
