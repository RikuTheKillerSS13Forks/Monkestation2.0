...
/obj/item/organ/internal/flesh_bud/proc/add_thrall_datum(datum/mind/mind)
	...
	var/datum/antagonist/vampire/antag_datum = mind.has_antag_datum(/datum/antagonist/vampire) // Check for *any* vampire antag datum here.
...
/obj/item/organ/internal/flesh_bud/proc/remove_thrall_datum(datum/mind/mind)
	...
	var/datum/antagonist/vampire/thrall/antag_datum = mind.has_antag_datum(/datum/antagonist/vampire/thrall) // Only check for the thrall antag datum here.
	if (antag_datum?.current_rank > 0)
		return
