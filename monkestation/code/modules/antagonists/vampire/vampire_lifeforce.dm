/datum/antagonist/vampire/update_life_force_changes()
...
/datum/antagonist/vampire/set_life_force_change(source, amount)
	life_force_changes[source] = amount
	update_life_force_changes()

/datum/antagonist/vampire/clear_life_force_change(source)
