/datum/action/changeling/fleshmend
	...
	helptext = "Lasts for 10 seconds and doesn't stack. If we're on fire, the healing effect wont function. Does not regrow limbs or restore lost blood. Functions while unconscious."
