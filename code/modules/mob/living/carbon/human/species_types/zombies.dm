...
/datum/species/zombie/infectious/on_species_gain(mob/living/carbon/C, datum/species/old_species)
	. = ..()
	C.AddComponent(/datum/component/mutant_hands, mutant_hand_path = mutant_hand_type) //monkestation edit: replaces the original mutant_hand_path with mutant_hand_type
