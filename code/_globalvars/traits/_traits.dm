...
*/
	...
	/mob = list(
		...
		"TRAIT_FEED_PROTECTION" = TRAIT_FEED_PROTECTION,
		...
		"TRAIT_MIND_BREAK" = TRAIT_MIND_BREAK,
		...
		"TRAIT_VAMPIRE_STARLIT" = TRAIT_VAMPIRE_STARLIT,
		"TRAIT_VAMPIRE_THIRST" = TRAIT_VAMPIRE_THIRST,
